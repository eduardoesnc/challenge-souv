...
export const useShoppingItemServiceCreateItemMutate = (
  ...
  useMutation({
    mutationFn: (shoppingItem: ShoppingItemRequestProps) =>
      ShoppingItemService.createShoppingItem(shoppingItem),
    ...options,
  });

export const useShoppingItemServiceRemoveItemMutate = (
  options?: UseMutationOptions<void, unknown, { id: string }, unknown>
) =>
  useMutation({
